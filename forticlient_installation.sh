...
### Unlock Gnome-keyring AS SUPERUSER!!!!!!
# Add su power to user
sudo usermod -aG sudo stream_client
su stream_client
### -c allows path to be non-su path aka readable by our non-su client.
sudo echo -n "9687" | gnome-keyring-daemon --unlock -c /home/stream_client/keyring
